      ...
      const { data, error } = await supabase
        ...
        .select(`
          *,
          ...
          material:materials(id, name, code),
          product:products(id, name, sku),
          production_lot:production_lots!corrective_actions_production_lot_id_fkey(id, lot_number),
          receiving_lot:receiving_lots!corrective_actions_receiving_lot_id_fkey(id, internal_lot_number),
          equipment:machines(id, name, machine_number),
          employee:employees(id, first_name, last_name, employee_number),
